...
void RoadMonster::Start()
{
	...
	Renderer->CreateAnimation("ReverseLeft_Turn", "Left_RoadMonster_Reverse.bmp", 0, 4, 0.07f, true);
	Renderer->CreateAnimation("ReverseRight_Turn", "Right_RoadMonster_Reverse.bmp", 4, 0, 0.07f, true);
